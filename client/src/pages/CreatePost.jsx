    ...
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w[500px]">
          Create imaginative and visually stunning images generated by DALL-E API and share them with the community</p>
      </div>
        ...
        <div className="flex flex-col gap-5">
          ...
          w-64 p-3 h-64 flex justify-center items-center">
            ...
            {generatingImg && (
              ...
              items-center items-center bg-[rgba(0,0,0,0.5)] rounded-lg">
                <Loader />
              </div>
            )}
          </div>
